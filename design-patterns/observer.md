# [Observer Design Pattern](https://www.youtube.com/watch?v=wiQdrH2YpT4&list=PLF206E906175C7E07&index=4)

## Oserver Pattern
- Positive
	- When you need many objects to receive an update on the change of another object
		- Publisher
		- Subscriber
	- Lose coupling between objects

- Negative
	- The subject may send updates that observers don't need 	
