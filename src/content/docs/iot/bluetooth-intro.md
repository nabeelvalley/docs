...
description: Connecting to, and Reading Data from Bluetooth Devices using Python and Bleak
---
...
![GATT Data hierarchy](/content/docs/iot/bluetooth-data-hierarchy.png)
