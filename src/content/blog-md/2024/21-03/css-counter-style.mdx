...
import '@/snippets/css-counter-style/cyclic.css'
import '@/snippets/css-counter-style/numeric.css'
...
<Snippet path="css-counter-style/cyclic.css" lang="css" />
...
<Snippet path="css-counter-style/numeric.css" lang="css" />
