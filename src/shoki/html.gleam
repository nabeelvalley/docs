...
pub fn h4(attrs, children) {
  element.element("h4", attrs, children)
}
...
pub fn h2(attrs, children) {
  element.element("h2", attrs, children)
}
...
pub fn h5(attrs, children) {
  element.element("h5", attrs, children)
}
...
pub fn geolocation(attrs, children) {
  element.element("geolocation", attrs, children)
}
...
pub fn area(attrs) {
  element.element("area", attrs, [])
}

/// Represent six levels of section headings. <h1> is the highest section level and <h6> is the lowest.
pub fn h3(attrs, children) {
  element.element("h3", attrs, children)
}
...
pub fn h1(attrs, children) {
  element.element("h1", attrs, children)
}
...
pub fn h6(attrs, children) {
  element.element("h6", attrs, children)
}
