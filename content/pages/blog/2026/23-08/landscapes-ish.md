---
title: Landscapes (ish)
description: Some photos taken with a wider aspect ratio
published: true
tags:
  - photography
---
...
<gallery path="blog/2026-08-15 - forest" />


I also tried some editing using [Darktable](https://www.darktable.org/) and went for a bit of a foresty theme [^1]
...
Overall, I think the wider aspect ratios were really fun. It really changed how I composed things and paired really well with the [TT Artisan 7.5mm lens](https://www.ttartisan.com/?aps-c-lenses/72.html) since it trims out some of the weird bits that take it from landscape to wonkscape
...
For what it's worth though, if you like the colours of the Amsterdam pictures they're using the [Fuji X Weekly Retro Gold Film Simulation](https://fujixweekly.com/2021/11/22/fujifilm-x-trans-iv-film-simulation-recipe-retro-gold/) which came out a bit moodier than expected
