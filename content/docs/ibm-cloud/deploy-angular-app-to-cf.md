...
![Create a GitHub Repository](/public/docs/assets/image%20%2820%29.png)

Upon creating a new repository you will see the next screen with instructions on how to push your repository to GitHub

![Push App to GitHub](/public/docs/assets/image%20%2823%29.png)
...
![Our App on GitHub](/public/docs/assets/image%20%2826%29.png)
...
![IBM Cloud Dashboard](/public/docs/assets/image%20%2814%29.png)
...
![DevOps Getting Started](/public/docs/assets/image%20%2839%29.png)
...
![Create a Toolchain](/public/docs/assets/image%20%2832%29.png)

Then we **name** our Toolchain and select the **Region,** and finally click **Create**

![Configure the Toolchain](/public/docs/assets/image%20%2817%29.png)
...
![Toolchain Overview](/public/docs/assets/image%20%2836%29.png)
...
![Add Tool Integration](/public/docs/assets/image%20%2835%29.png)
...
![Configure the GitHub Integration](/public/docs/assets/image%20%2837%29.png)
...
![GitHub Toolchain](/public/docs/assets/image%20%2813%29.png)
...
![Add Delivery Pipeline](/public/docs/assets/image%20%2828%29.png)

This will direct us to the Tool Configuration page, in which we set our **Pipeline Name**, and click **Create Integration**

![Configure the Integration](/public/docs/assets/image%20%2811%29.png)

Once we have done that we will see Delivery Pipeline on our dashboard

![Final List of Tools](/public/docs/assets/image%20%2810%29.png)
...
![Toolchain Overview](/public/docs/assets/image%20%2827%29.png)
...
![Configure Build Stage](/public/docs/assets/image%20%285%29.png)

Next scroll back up and click on **Jobs** then add a Build Job to our stage

![Create a Build Job](/public/docs/assets/image%20%289%29.png)

And select our **Builder Type** as _**npm**_

![npm Build Type](/public/docs/assets/image%20%2838%29.png)
...
![Build Script and Build Directory](/public/docs/assets/image%20%2834%29.png)

Once we are done with that we can click **Save** which will take us back to our Delivery Pipeline stage view

![Delivery Pipeline with Build Stage](/public/docs/assets/image%20%2818%29.png)
...
![Deploy Stage Configuration](/public/docs/assets/image%20%2815%29.png)
...
![Deploy Job Creation](/public/docs/assets/image%20%2819%29.png)
...
![Deploy Script Configuration](/public/docs/assets/image%20%283%29.png)
...
![Complete Delivery Pipeline](/public/docs/assets/image%20%281%29.png)

When our Build and Deploy have completed successfully we will see the following

![Build and Deployment Completed Successfully](/public/docs/assets/image%20%2822%29.png)
...
![Our Application Resource on the Dashboard](/public/docs/assets/image%20%2831%29.png)
...
![Application Resource Screen](/public/docs/assets/image%20%2825%29.png)

Lastly we can open our Application Site via the **Visit App URL** link at the top

![Our Application](/public/docs/assets/image%20%2816%29.png)
